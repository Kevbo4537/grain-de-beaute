...
const pages = ['', 'technique-mixte-sourcils/', 'maquillage-semi-permanent-sourcils-tours/', 'difference-microblading-microshading-technique-mixte/', 'prix-microblading-tours/', 'cicatrisation-microblading-conseils/', 'retouche-fixatrice-sourcils/', 'choisir-professionnelle-microblading-tours/', 'deroulement-seance/', 'cicatrisation-conseils/', 'tarifs/', 'galerie/', 'demande-avis-sourcils/', 'sophie-bodin/', 'hygiene-securite/', 'technique-mixte-sourcils-pres-de-tours/', 'contact/', 'mentions-legales/', 'confidentialite/'];
